                ...
                <div class="widget-inner">
                    <div class="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input class="form-control" readonly value="{{$detail->invoice_id ?? ''}}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input class="form-control" readonly value="{{$detail->payment_status == 0 ? 'Unpaid' : 'Paid' }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Verify</label>
                            <div class="col-sm-7">
                                <input class="form-control" readonly value="{{$detail->approve_status == 0 ? 'Pending' : 'Completed' }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <a  href="{{ $detail->payment_status == 1 ? '#' : route('customer.payment.create', $detail->id) }}"
