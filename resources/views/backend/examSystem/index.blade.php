...
<div class="card">
    <div class="card-body">
        <h4 class="card-title text-center font-weight-bold text-base ">All Exam Information</h4>
            ...
            <div class="col-12">
                <div class="card-header d-flex justify-content-between mb-4">
                    <div>
                        ...
                        <a href="{{route('exam.system.create')}}" class="btn btn-sm btn-info" >
