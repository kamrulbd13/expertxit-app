...
@section('mainContent')
    ...
    <div class="card ">
        <div class="card-body">
            <h4 class="card-title text-center font-weight-bold text-base text-uppercase">New Trainer Type Information</h4>
            <hr class="w-50 mx-auto">
            <p class="card-description">
              " Entry Basic Trainer Type Information "
            </p>
            <form action="{{route('trainer.type.store')}}" method="POST" class="forms">
                @csrf
                <div class="form-group mb-2">
                    <label for="school-id" class="col-form-label">Trainer Type</label>
                    <input type="text" name="trainer_type" class="form-control form-control-sm"  />
                    @error('trainer_type')
                        <span class="text-danger mt-1">Please entry the Trainer Type</span>
                    @enderror
