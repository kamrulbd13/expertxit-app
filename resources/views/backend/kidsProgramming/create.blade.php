        ...
        <div class="card-body">
            ...
            <form action="{{route('kidsProgramme.store')}}" method="POST" class="forms" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" name="trainingDetails" id="trainingDetails"></textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" name="learning_outcome" id="learning_outcome"></textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" name="certification" id="Certificate_details"></textarea>
                    @error('certification')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="assessment" id="assessment">
                            @error('assessment')
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="quizzes" id="quizzes"></input>
                            @error('quizzes')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="lecture" id="lecture">
                            @error('lecture')
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="duration" id="duration"></input>
                            @error('duration')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="regular_fees" id="regular_fees">
                            @error('regular_fees')
                            <span class="text-danger mt-1">Please entry the regular fees</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" class="form-control form-control-sm" name="current_fees" id="current_fees"></input>
                            @error('current_fees')
                            <span class="text-danger mt-1">Please entry the regular fees</span>
                            @enderror
                        </div>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" name="prerequisite" id="prerequisite"></textarea>
                    @error('prerequisite')
                        ...
                        <div class="form-group mt-3">
                            ...
                            <select class="form-control" name="trainer_type_id" id="trainer_type_id">
                                ...
                                @foreach($trainerTypes as $item)
                                    <option value="{{$item->id}}">{{$item->trainer_type}}</option>
                                @endforeach
...
{{--                image--}}
                ...
                <div id="curriculum-container">
                    <div class="curriculum-row row mb-2">
                        <div class="col-md-2">
                            <input type="text" name="trainingCurriculum[0][title]" class="form-control" placeholder="Title" required>
                        </div>
                        <div class="col-md-2">
                            <input type="text" name="trainingCurriculum[0][sub_title]" class="form-control" placeholder="Sub Title">
                        </div>
                        <div class="col-md-5">
                            <input type="text" name="trainingCurriculum[0][description]" class="form-control" placeholder="Description">
                        </div>
                        <div class="col-md-2">
                            <input type="number" name="trainingCurriculum[0][duration]" class="form-control" placeholder="Duration (min)" required>
                        </div>

                        <div class="col-md-1 d-flex gap-1">
                            <button type="button" class="btn btn-success btn-sm btn-add" style="height: 46px;">+</button>&nbsp
            ...
            <!-- Script to handle add/remove rows -->
                <script>
                    let index = 1;
        ...
        <div class="curriculum-row row mb-2">
            ...
            <div class="col-md-1 d-flex gap-1">
                <button type="button" class="btn btn-success btn-add btn-sm" style="height: 46px;">+</button> &nbsp
                <button type="button" class="btn btn-danger btn-remove btn-sm" style="height: 46px;">x</button>
            </div>
        </div>
        `;
          }
                    ...
                    document.addEventListener('click', function (e) {
                        ...
                        if (e.target.classList.contains('btn-remove')) {
                            ...
                            if (document.querySelectorAll('.curriculum-row').length > 1) {
                                row.remove();
                            }
                        }
                    });
