...
@section('mainContent')
    ...
    <div class="card ">
        <div class="card-body">
            <h4 class="card-title text-center font-weight-bold text-base text-uppercase">New Category Information</h4>
            <hr class="w-50 mx-auto">
            <p class="card-description">
                " Entry Basic Category Information "
            </p>
            <form action="{{route('kidsProgramme.category.store')}}" method="POST" class="forms">
                @csrf
