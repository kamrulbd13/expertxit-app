...
@section('mainContent')
    ...
    <div class="card ">
        <div class="card-body">
            <h4 class="card-title text-center font-weight-bold text-base text-uppercase">New Skill levelInformation</h4>
            <hr class="w-50 mx-auto">
            <p class="card-description">
              " Entry Skill level Information "
            </p>
            <form action="{{route('skill.level.store')}}" method="POST" class="forms">
                @csrf
                <div class="form-group mb-2">
                    <label for="school-id" class="col-form-label">Skill Level</label>
