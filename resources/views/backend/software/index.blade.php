...
<div class="card">
    <div class="card-body">
        <h4 class="card-title text-center font-weight-bold text-base text-uppercase">All Software Information</h4>
            ...
            <div class="col-12">
                <div class="card-header d-flex justify-content-between mb-4">
                    <div>
                        ...
                        <a href="{{route('software.create')}}" class="btn btn-sm btn-info" >
