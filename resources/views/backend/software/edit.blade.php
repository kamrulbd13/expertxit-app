...
@section('mainContent')
    <div class="card ">
        <div class="card-body">
            ...
            <form action="{{route('software.update', $software)}}" method="POST" class="forms" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="name" value="{{$software->name}}" class="form-control form-control-sm"  />
                    @error('name')
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea  class="form-control form-control-sm" name="why_choose_our_solution" id="why_choose_our_solution">
                        {!! $software->why_choose_our_solution !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control form-control-sm" name="benefits_for_every_stakeholder" id="benefits_for_every_stakeholder">
                        {!! $software->benefits_for_every_stakeholder !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <img src="{{asset($software->image_path)}}" width="100px;" class="rounded mt-2 ms-2" alt="">
                    @error('image')
