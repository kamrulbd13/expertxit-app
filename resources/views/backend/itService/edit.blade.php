...
@section('mainContent')
    <div class="card ">
        <div class="card-body">
            ...
            <form action="{{route('itService.update', $itService)}}" method="POST" class="forms" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mt-3">
                            <label for="itService_category_id">Category</label>
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="name" value="{{$itService->name}}" class="form-control form-control-sm"  />
                    @error('name')
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" name="core_features" id="core_features">
                        {!! $itService->core_features !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control" name="advanced_modules" id="advanced_modules">
                        {!! $itService->advanced_modules !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea  class="form-control form-control-sm" name="why_choose_our_solution" id="why_choose_our_solution">
                        {!! $itService->why_choose_our_solution !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control form-control-sm" name="benefits_for_every_stakeholder" id="benefits_for_every_stakeholder">
                        {!! $itService->benefits_for_every_stakeholder !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea class="form-control form-control-sm" name="get_started_today" id="get_started_today">
                        {!! $itService->get_started_today !!}
                    </textarea>
                ...
                <div class="form-group mb-2">
                    ...
                    <img src="{{asset($itService->image_path)}}" width="100px;" class="rounded mt-2 ms-2" alt="">
                    @error('image')
