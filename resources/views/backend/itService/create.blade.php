...
@section('mainContent')
    <div class="card ">
        <div class="card-body">
            ...
            <form action="{{route('itService.store')}}" method="POST" class="forms" enctype="multipart/form-data">
                @csrf
                ...
                <div class="text-center mt-4">
                    <a href="{{route('itService.index')}}" class="btn btn-danger" data-dismiss="modal">
