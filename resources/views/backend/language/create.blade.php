...
@section('mainContent')
    ...
    <div class="card ">
        <div class="card-body">
            <h4 class="card-title text-center font-weight-bold text-base text-uppercase">New Language Information</h4>
            <hr class="w-50 mx-auto">
            <p class="card-description">
              " Entry Language Information "
            </p>
            <form action="{{route('language.store')}}" method="POST" class="forms">
                @csrf
                <div class="form-group mb-2">
                    <label for="school-id" class="col-form-label">Language name</label>
