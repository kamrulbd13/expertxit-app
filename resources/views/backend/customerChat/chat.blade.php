...
@section('mainContent')
    ...
    <div id="top-alert" style="position: fixed; top: 20px; right: 20px; z-index: 1050; min-width: 250px; display: none;">
        <div id="top-alert-message" class="alert alert-danger mb-0" role="alert"></div>
          ...
          <div class="card d-flex flex-column p-2"  style="height: 125vh;" id="myCard">
            <h4 class="card-title text-center font-weight-bold text-uppercase">
                ...
                <div class="card bg-primary text-white shadow-md w-25 mx-auto p-2 mt-2">
                    Admin Chat Panel
                </div>
            </h4>
            ...
            <div class="row flex-grow-1" style="overflow: hidden;">
                ...
                <div class="col-md-8 d-flex flex-column" style="height: 100%;">
                    ...
                    <div id="chat-messages" class="flex-grow-1 p-3  border"
                         style="font-size: 12px; height: 300px; overflow-y: auto; border-radius: 5px; background-color: #F7FAFF">
...
{{--chat scritp --}}
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function insertDateSeparator(dateLabel) {
                ...
                separator.classList.add('text-center', 'text-muted', 'my-2', 'date-separator');
                separator.innerHTML = `
    ...
    <script>
        ...
        toggleBtn.addEventListener('click', () => {
            ...
            toggleBtn.title = isFullscreen ? 'Exit Fullscreen' : 'Toggle Fullscreen';
        });
    </script>
@endsection
