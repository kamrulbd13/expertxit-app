...
@section('mainContent')
    ...
    <div class="card ">
        <div class="card-body">
            <h4 class="card-title text-center font-weight-bold text-base text-uppercase">New Batch ID Information</h4>
            <hr class="w-50 mx-auto">
            <p class="card-description">
              " Entry Information "
            </p>
            <form action="{{route('backend.new.batch.upcoming.store')}}" method="POST" class="forms">
               @csrf
                <div class="row">
                    <div class="col-md-8">
...
{{--                new batch id --}}
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="batch_id" readonly id="batch_id" class="form-control form-control-sm"  />
                </div>
