<style>
    ...
    * {
    ...
    .btn-primary:hover, .btn-primary:focus { background-color: var(--primary-dark); border-color: var(--primary-dark); box-shadow:0 5px 15px rgba(0,102,220,0.25); transform:translateY(-2px); outline:none; }
    .btn-outline-primary { border:2px solid var(--primary); color: var(--primary); }
    .btn-outline-primary:hover, .btn-outline-primary:focus { background-color: var(--primary); color:white; outline:none; }

    /* Topbar */
    .topbar { background: var(--dark); color:#f1f5f9; font-size:0.875rem; padding:0.45rem 0; }
    .topbar a { color: #cbd5e1; }
    .topbar a:hover,a:focus { color: var(--primary-light); outline:none; }
    .topbar .social a { color:#cbd5e1; margin-left:1rem; font-size:1rem; }
    .topbar .social a:hover,a:focus { color: var(--primary); transform:translateY(-2px); outline:none; }
    ...
    .nav-link { font-weight:600; padding:0.5rem 1.1rem; color: var(--dark); position: relative; display:flex; align-items:center; gap:0.5rem; }
    .nav-link:hover,.nav-link:focus { color: var(--primary); outline:none; }
    .nav-link.active { color: var(--primary); }
    .nav-link.active::after { content:''; position:absolute; bottom:0; left:1rem; right:1rem; height:3px; background-color: var(--primary); border-radius:3px 3px 0 0; }
    ...
    .mega-menu a i { margin-right:0.75rem; width:1.4rem; text-align:center; font-size:1.1rem; color:var(--accent); }
    .mega-menu a:hover, .mega-menu a:focus { background-color: var(--primary); color:white; outline:none; }
    .mega-menu a.selected { background-color: var(--primary-dark); color:white; }

    /* Responsive */
    @media (max-width: 991px) {
        .navbar-brand { padding-left:1rem; }
        .logo-box { width:140px; height:50px; }
        .dropdown-menu.mega-menu { width:95vw !important; left:50% !important; transform:translateX(-50%); padding:1rem 1.5rem; border-radius:0 0 10px 10px; }
    }
</style>
