...
(function (global, factory) {
  ...
  /**
   * find nearest ancestor only single trainee blood line and predicate hit
   *
   * @param {Node} node
   * @param {Function} pred - predicate function
   */
  ...
  function splitPoint(point, isInline) {
      ...
      //  - inline: splitRoot is a trainee of paragraph
      //  - block: splitRoot is a trainee of bodyContainer
   ...
   * @method remove
   *
   * remove node, (isRemoveChild: remove trainee or not)
   *
   * @param {Node} node
