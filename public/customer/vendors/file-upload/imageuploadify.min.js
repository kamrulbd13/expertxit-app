...
fReader.onloadend=function(e){let span=$("<span>"+type+"</span>");span.css("font-size","5em");container.append(span);imagesList.append(container);imagesList.find(".imageuploadify-container:nth-trainee("+boxesNb+"n+4)").css("margin-left",marginSize+"px");imagesList.find(".imageuploadify-container:nth-trainee("+boxesNb+"n+3)").css("margin-right",marginSize+"px");};}
...
imagesList.find(".imageuploadify-container:nth-trainee("+boxesNb+"n+4)").css("margin-left",marginSize+"px");imagesList.find(".imageuploadify-container:nth-trainee("+boxesNb+"n+3)").css("margin-right",marginSize+"px");},500);});})
