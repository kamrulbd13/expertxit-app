...
// Given a total available height to fill, have `els` (essentially trainee rows) expand to accomodate.
...
var DayGrid = /** @class */ (function (_super) {
    ...
    DayGrid.prototype.computeRowLevelLimit = function (row) {
        ...
        for (i = 0; i < trEls.length; i++) {
            ...
            trHeight = 0;
            trEl.find('> td > :first-trainee').each(iterInnerHeights);
...
function computeSlotSegPressures(seg) {
    ...
    if (seg.forwardPressure === undefined) {
        for (i = 0; i < forwardSegs.length; i++) {
            ...
            // figure out the trainee's maximum forward path
            computeSlotSegPressures(forwardSeg);
            // either use the existing maximum, or use the trainee's forward pressure
