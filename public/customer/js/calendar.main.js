/*!
Fullcalendars v5.11.3
*/
var Fullcalendars = (function (e) {
    "use strict";
    var t = function (e, n) {
        return (t =
    ...
    ge.FullcalendarsVDom
        ? console.warn("Fullcalendars VDOM already loaded")
        : (ge.FullcalendarsVDom = {
            Component: y,
            createElement: v,
            render: L,
                    ...
                    (e.prototype.formatRange = function (e, t, n, r) {
                        var o = this.standardDateProps,
                            ...
                            a = (function (e, t, n) {
                                ...
                                return 0;
                            })(e.marker, t.marker, n.calendarsSystem);
    ...
    function on(e, t, n, r) {
        var o = rn(e, n.calendarsSystem);
        return { date: o, start: o, end: t ? rn(t, n.calendarsSystem) : null, timeZone: n.timeZone, localeCodes: n.locale.codes, defaultSeparator: r || n.defaultSeparator };
    }
    var an = (function () {
            function e(e) {
                this.cmdStr = e;
    ...
    function mr(e, t, n) {
        n.emitter.trigger("select", r(r({}, yr(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarsApi.view }));
    }
    function yr(e, t) {
    ...
    var Cr = (function () {
            ...
            return (
                Object.defineProperty(e.prototype, "calendars", {
                    get: function () {
                        return this.getCurrentData().calendarsApi;
                    },
                    enumerable: !1,
                    configurable: !0,
                }),
    ...
    var kr = (function () {
            ...
            return (
                (e.prototype.getCurrentData = function () {
                    ...
                    (e.prototype.getOption = function (e) {
                        return this.currentDataManager.currentcalendarsOptionsInput[e];
                    }),
                    ...
                    (e.prototype.on = function (e, t) {
                        ...
                        n.currentcalendarsOptionsRefiners[e] ? n.emitter.on(e, t) : console.warn("Unknown listener name '" + e + "'");
                    }),
                    ...
                    (e.prototype.today = function () {
                        var e = this.getCurrentData();
                        this.unselect(), this.dispatch({ type: "CHANGE_DATE", dateMarker: Tr(e.calendarsOptions.now, e.dateEnv) });
                    }),
                    ...
                    (e.prototype.unselect = function (e) {
                        ...
                        (this.dispatch({ type: "UNSELECT_DATES" }),
                            (function (e, t) {
                                t.emitter.trigger("unselect", { jsEvent: e ? e.origEvent : null, view: t.viewApi || t.calendarsApi.view });
                            })(e, t));
                    }),
    ...
    var Lr = (function () {
            function e(e) {
                ...
                e.namedTimeZoneImpl && n && (this.namedTimeZoneImpl = new e.namedTimeZoneImpl(t)),
                    ...
                    (this.calendarsSystem = (function (e) {
                        return new Pr[e]();
                    })(e.calendarsSystem)),
            ...
            return (
                (e.prototype.createMarker = function (e) {
                    ...
                    (e.prototype.getYear = function (e) {
                        return this.calendarsSystem.getMarkerYear(e);
                    }),
                    (e.prototype.getMonth = function (e) {
                        return this.calendarsSystem.getMarkerMonth(e);
                    }),
                    (e.prototype.add = function (e, t) {
                        var n = this.calendarsSystem.markerToArray(e);
                        return (n[0] += t.years), (n[1] += t.months), (n[2] += t.days), (n[6] += t.milliseconds), this.calendarsSystem.arrayToMarker(n);
                    }),
                    ...
                    (e.prototype.addYears = function (e, t) {
                        var n = this.calendarsSystem.markerToArray(e);
                        return (n[0] += t), this.calendarsSystem.arrayToMarker(n);
                    }),
                    (e.prototype.addMonths = function (e, t) {
                        var n = this.calendarsSystem.markerToArray(e);
                        return (n[1] += t), this.calendarsSystem.arrayToMarker(n);
                    }),
                    (e.prototype.diffWholeYears = function (e, t) {
                        var n = this.calendarsSystem;
                    ...
                    (e.prototype.startOfYear = function (e) {
                        return this.calendarsSystem.arrayToMarker([this.calendarsSystem.getMarkerYear(e)]);
                    }),
                    (e.prototype.startOfMonth = function (e) {
                        return this.calendarsSystem.arrayToMarker([this.calendarsSystem.getMarkerYear(e), this.calendarsSystem.getMarkerMonth(e)]);
                    }),
                    (e.prototype.startOfWeek = function (e) {
                        return this.calendarsSystem.arrayToMarker([this.calendarsSystem.getMarkerYear(e), this.calendarsSystem.getMarkerMonth(e), e.getUTCDate() - ((e.getUTCDay() - this.weekDow + 7) % 7)]);
                    }),
    ...
    function jr(e) {
        ...
        return new Lr(r(r({ timeZone: cn.timeZone, calendarsSystem: "gregory" }, e), { locale: t }));
    }
    var Gr,
    ...
    if (((wo.prototype.classes = {}), (wo.prototype.iconClasses = {}), (wo.prototype.baseIconClass = ""), (wo.prototype.iconOverridePrefix = ""), "undefined" == typeof FullcalendarsVDom))
        throw new Error("Please import the top-level fullcalendars lib before attempting to import a plugin.");
    var Ro = FullcalendarsVDom.Component,
        _o = FullcalendarsVDom.createElement,
        To = FullcalendarsVDom.render,
        ko = FullcalendarsVDom.createRef,
        xo = FullcalendarsVDom.Fragment,
        Mo = FullcalendarsVDom.createContext,
        Io = FullcalendarsVDom.createPortal,
        Po = FullcalendarsVDom.flushSync,
        No = FullcalendarsVDom.unmountComponentAtNode,
        Ho = (function () {
            function e(e, t, n, o) {
                var i = this;
                (this.execFunc = e),
    ...
    function zo(e) {
        return {
            ...
            calendarsInteractions: e.calendarsInteractions || [],
                        ...
                        for (var t = 0, a = e; t < a.length; t++) {
                            ...
                            ((n[s.id] = !0),
                                ...
                                (o = {
                                    ...
                                    calendarsInteractions: l.calendarsInteractions.concat(u.calendarsInteractions),
            ...
            (e.prototype.buildPrev = function (e, t, n) {
                ...
                (e.prototype.buildValidRange = function () {
                    var e = this.props.validRangeInput,
                        t = "function" == typeof e ? e.call(this.props.calendarsApi, this.nowDate) : e;
                ...
                (e.prototype.buildCustomVisibleRange = function (e) {
                    var t = this.props,
                        ...
                        r = "function" == typeof n ? n.call(t.calendarsApi, t.dateEnv.toDate(e)) : n,
    ...
    function ki(e, t) {
        ...
        for (var p = 0, f = r; p < f.length; p++) {
            var h = f[p];
            t.calendarsApi.addEventSource(h);
        }
    }
    var xi = [
        zo({
    ...
    var Ni = (function () {
        function e(e) {
            ...
            (this.computeOptionsData = qt(this._computeOptionsData)),
                ...
                (this.currentcalendarsOptionsInput = {}),
                (this.currentcalendarsOptionsRefined = {}),
                (this.currentViewOptionsInput = {}),
                (this.currentViewOptionsRefined = {}),
                (this.currentcalendarsOptionsRefiners = {}),
            ...
            var n = {},
                o = this.computeOptionsData(e.optionOverrides, n, e.calendarsApi),
                i = o.calendarsOptions.initialView || o.pluginHooks.initialView,
                a = this.computeCurrentViewData(i, o, e.optionOverrides, n);
            (e.calendarsApi.currentDataManager = this), this.emitter.setThisContext(e.calendarsApi), this.emitter.setOptions(a.options);
            var s,
                l,
                u,
                c = ((s = o.calendarsOptions), (l = o.dateEnv), null != (u = s.initialDate) ? l.createMarker(u) : Tr(s.now, l)),
                d = a.dateProfileGenerator.build(c);
            Zn(d.activeRange, c) || (c = d.currentRange.start);
            for (
                var p = { dateEnv: o.dateEnv, options: o.calendarsOptions, pluginHooks: o.pluginHooks, calendarsApi: e.calendarsApi, dispatch: this.dispatch, emitter: this.emitter, getCurrentData: this.getCurrentData },
                    f = 0,
            ...
            for (
                var v = si(o.calendarsOptions, d, p),
                    g = {
            ...
            (e.prototype.resetOptions = function (e, t) {
                ...
                (e.prototype._handleAction = function (e) {
                    var t = this,
                        ...
                        s = this.computeOptionsData(n.optionOverrides, a, n.calendarsApi),
                        l = (function (e, t) {
                            switch (t.type) {
                                case "CHANGE_VIEW_TYPE":
                                    e = t.viewType;
                    ...
                    (n.calendarsApi.currentDataManager = this), i.setThisContext(n.calendarsApi), i.setOptions(u.options);
                    var c = { dateEnv: s.dateEnv, options: s.calendarsOptions, pluginHooks: s.pluginHooks, calendarsApi: n.calendarsApi, dispatch: this.dispatch, emitter: i, getCurrentData: this.getCurrentData },
                        d = o.currentDate,
                        p = o.dateProfile;
                ...
                (e.prototype.updateData = function () {
                    var e,
                        ...
                        d = this.state,
                        p = this.data,
                        f = this.computeOptionsData(c.optionOverrides, d.dynamicOptionOverrides, c.calendarsApi),
                        h = this.computeCurrentViewData(d.currentViewType, f, c.optionOverrides, d.dynamicOptionOverrides),
                        v = (this.data = r(r(r({ viewTitle: this.buildTitle(d.dateProfile, h.options, f.dateEnv), calendarsApi: c.calendarsApi, dispatch: this.dispatch, emitter: this.emitter, getCurrentData: this.getCurrentData }, f), h), d)),
                        g = f.pluginHooks.optionChangeHandlers,
                        m = p && p.calendarsOptions,
                        y = f.calendarsOptions;
                    if (m && m !== y)
                ...
                (e.prototype._computeOptionsData = function (e, t, n) {
                    var r = this.processRawcalendarsOptions(e, t),
                        o = r.refinedOptions,
                        i = r.pluginHooks,
                        a = r.localeDefaults,
                    ...
                    return { calendarsOptions: o, pluginHooks: i, dateEnv: l, viewSpecs: u, theme: c, toolbarConfig: this.parseToolbars(o, e, c, u, n), localeDefaults: a, availableRawLocales: s.map };
                }),
                (e.prototype.processRawcalendarsOptions = function (e, t) {
                    var n = gn([cn, e, t]),
                        o = n.locales,
                        i = n.locale,
                        ...
                        c = (this.currentcalendarsOptionsRefiners = r(r(r(r(r({}, un), dn), pn), u.listenerRefiners), u.optionRefiners)),
                        d = {},
                        p = gn([cn, l, e, t]),
                        f = {},
                        h = this.currentcalendarsOptionsInput,
                        v = this.currentcalendarsOptionsRefined,
                        g = !1;
                    for (var m in p) "plugins" !== m && (p[m] === h[m] || (fn[m] && m in h && fn[m](h[m], p[m])) ? (f[m] = v[m]) : c[m] ? ((f[m] = c[m](p[m])), (g = !0)) : (d[m] = h[m]));
                    return (
                        g && ((this.currentcalendarsOptionsInput = p), (this.currentcalendarsOptionsRefined = f)),
                            { rawOptions: this.currentcalendarsOptionsInput, refinedOptions: this.currentcalendarsOptionsRefined, pluginHooks: u, availableLocaleData: a, localeDefaults: l, extra: d }
                    );
                }),
                        ...
                        zi(i.extra),
                            {
                                ...
                                dateProfileGenerator: this.buildDateProfileGenerator({
                                    ...
                                    dateEnv: t.dateEnv,
                                    calendarsApi: this.props.calendarsApi,
                ...
                (e.prototype.processRawViewOptions = function (e, t, n, o, i) {
                    ...
                    for (var f in a)
                        a[f] === u[f] || (fn[f] && fn[f](a[f], u[f]))
                            ? (l[f] = c[f])
                            : (a[f] === this.currentcalendarsOptionsInput[f] || (fn[f] && fn[f](a[f], this.currentcalendarsOptionsInput[f]))
                            ? f in this.currentcalendarsOptionsRefined && (l[f] = this.currentcalendarsOptionsRefined[f])
                            : s[f]
                                ? (l[f] = s[f](a[f]))
                                : (p[f] = a[f]),
                                (d = !0));
    ...
    function Hi(e, t, n, r, o, i, a, s) {
        ...
        return new Lr({ calendarsSystem: "gregory", timeZone: e, namedTimeZoneImpl: i.namedTimeZonedImpl, locale: l, weekNumberCalculation: n, firstDay: r, weekText: o, cmdFormatter: i.cmdFormatter, defaultSeparator: s });
    }
    function Oi(e, t) {
        ...
        function t(t) {
            ...
            return (
                (n.handleData = function (e) {
                    ...
                    (n.dataManager = new Ni({ optionOverrides: t.optionOverrides, calendarsApi: t.calendarsApi, onData: n.handleData })),
                    n
            );
        }
        return (
    ...
    var la = (function (e) {
            ...
            return (
                n(t, e),
                    ...
                    //         });
                    //     return _o.apply(void 0, o(["div", { className: "" }], t));
                    // }),
        ...
        fa = (function (e) {
            ...
            return (
                n(t, e),
                    ...
                    (t.prototype.componentDidMount = function () {
                        var e = this.props;
                        (this.calendarsInteractions = e.pluginHooks.calendarsInteractions.map(function (t) {
                            return new t(e);
                        })),
                    ...
                    (t.prototype.componentWillUnmount = function () {
                        ...
                        for (var e = 0, t = this.calendarsInteractions; e < t.length; e++) {
                            t[e].destroy();
                        }
                    ...
                    (t.linkElRef = ko()),
                        ...
                        (t.handleClick = function (e) {
                            ...
                            "function" == typeof i && (i = i({ date: a, allDay: Boolean(r.allDayDate), allSegs: r.allSegs.map(s), hiddenSegs: r.hiddenSegs.map(s), jsEvent: e, view: o.viewApi })),
                                i && "popover" !== i ? "string" == typeof i && o.calendarsApi.zoomTo(a, i) : t.setState({ isPopoverOpen: !0 });
                        }),
            ...
            return (
                (o.isRendering = !1),
                    ...
                    (o.handleData = function (e) {
                        (o.currentData = e), o.renderRunner.request(e.calendarsOptions.rerenderDelay);
                    }),
                    (o.handleRenderRequest = function () {
                        if (o.isRendering) {
                            ...
                            Po(function () {
                                To(
                                    _o(ga, { options: e.calendarsOptions, theme: e.theme, emitter: e.emitter }, function (t, n, i, a) {
                    ...
                    new Ni({ optionOverrides: n, calendarsApi: o, onAction: o.handleAction, onData: o.handleData }),
                    o
            );
        }
        return (
                ...
                (n.handlePointerDown = function (e) {
                    ...
                    (n.handleDragEnd = function (e) {
                        ...
                        if (!n.dragging.pointer.wasTouchScroll) {
                            ...
                            if (i && a && Us(i, a)) {
                                var s = t.context,
                                    l = r(r({}, Ws(i.dateSpan, s)), { dayEl: i.dayEl, jsEvent: e.origEvent, view: s.viewApi || s.calendarsApi.view });
            ...
            function t(t) {
                ...
                (n.dragSelection = null),
                    ...
                    (n.handleDragStart = function (e) {
                        n.component.context.calendarsApi.unselect(e);
                    }),
        ...
        function t(n) {
            ...
            (o.subjectEl = null),
                ...
                (o.handleDragStart = function (e) {
                    ...
                    o.isDragging && (t.calendarsApi.unselect(e), t.emitter.trigger("eventDragStart", { el: o.subjectEl, event: new xr(t, n.def, n.instance), jsEvent: e.origEvent, view: t.viewApi }));
                }),
        ...
        function t(t) {
            ...
            (n.draggingSegEl = null),
                ...
                (n.handleDragStart = function (e) {
                    ...
                    (n.draggingSegEl = o), (n.draggingSeg = Jn(o)), t.calendarsApi.unselect(), t.emitter.trigger("eventResizeStart", { el: o, event: new xr(t, r.def, r.instance), jsEvent: e.origEvent, view: t.viewApi });
                }),
                    ...
                    (this.onDocumentPointerUp = function (e) {
                        ...
                        if (!r.wasTouchScroll) {
                            if (o.dateSelection && !t.isRecentPointerDateSelect) {
                                ...
                                !i || (i && t.matchesCancel) || n.calendarsApi.unselect(e);
                            }
        ...
        Ys = (function () {
            function e(e, t) {
                ...
                (this.receivingContext = null),
                    ...
                    (this.handleHitUpdate = function (e, t, o) {
                        ...
                        e &&
                        ((a = e.context),
                        n.canDropElOncalendars(o.subjectEl, a) &&
                        ((s = (function (e, t, n) {
            ...
            return (
                (e.prototype.buildDragMeta = function (e) {
                    ...
                    (e.prototype.canDropElOncalendars = function (e, t) {
                        var n = t.options.dropAccept;
                        return "function" == typeof n ? n.call(t.calendarsApi, e) : "string" != typeof n || !n || Boolean(be(e, n));
                    }),
                    e
            );
        })();
    ...
    var Zs = (function () {
        ...
        $s = zo({ componentInteractions: [Vs, Fs, Bs, zs], calendarsInteractions: [js], elementDraggingImpl: Os, optionRefiners: Gs, listenerRefiners: qs }),
        Js = (function (e) {
            function t() {
                var t = (null !== e && e.apply(this, arguments)) || this;
    ...
    var bu = zo({ themeClasses: { bootstrap5: Su } }),
        Du = "https://www.googleapis.com/calendars/v3/calendarss";
    var Cu = zo({
        eventSourceDefs: [
            {
                parseMeta: function (e) {
                    var t = e.googlecalendarsId;
                    return (
                        !t &&
                        e.url &&
                        (t = (function (e) {
                            ...
                            if ((t = /^https:\/\/www.googleapis.com\/calendars\/v3\/calendarss\/([^/]*)/.exec(e)) || (t = /^https?:\/\/www.google.com\/calendars\/feeds\/([^/]*)/.exec(e))) return decodeURIComponent(t[1]);
                            return null;
                        })(e.url)),
                            t ? { googlecalendarsId: t, googlecalendarsApiKey: e.googlecalendarsApiKey, googlecalendarsApiBase: e.googlecalendarsApiBase, extraParams: e.extraParams } : null
                    );
                },
                fetch: function (e, t, n) {
                    var o = e.context,
                        ...
                        l = s.googlecalendarsApiKey || a.googlecalendarsApiKey;
                    if (l) {
                        var u = (function (e) {
                                var t = e.googlecalendarsApiBase;
                                t || (t = Du);
                                return t + "/" + encodeURIComponent(e.googlecalendarsId) + "/events";
                            })(s),
                            c = s.extraParams,
                        ...
                        _i(
                            ...
                            function (e, r) {
                                var o, i;
                                e.error
                                    ? n({ message: "Google calendars API: " + e.error.message, errors: e.error.errors, xhr: r })
                                    : t({
                                        rawEvents:
                                            ((o = e.items),
                                                (i = p.timeZone),
                    ...
                    } else n({ message: "Specify a googlecalendarsApiKey. See http://fullcalendars.io/docs/google_calendars/" });
                },
            },
        ],
        optionRefiners: { googlecalendarsApiKey: String },
        eventSourceRefiners: { googlecalendarsApiKey: String, googlecalendarsId: String, googlecalendarsApiBase: String, extraParams: yn },
    });
    return (
        xi.push($s, Cl, su, mu, Eu, bu, Cu),
            ...
            (e.calendars = Cs),
            (e.calendarsApi = kr),
            (e.calendarsContent = fa),
            (e.calendarsDataManager = Ni),
            (e.calendarsDataProvider = ji),
            (e.calendarsRoot = ga),
            (e.Component = Ro),
            (e.ContentHook = Xo),
